...
const WhoIsMintplex = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          'url("https://mintplex.xyz/static/media/teambg.0297d4dc.webp")',
        backgroundRepeat: "no-repeat",
        backgroundSize: "100% 100%",
      }}
    >
      <div className="bg-[#e9c05c] w-full md:w-3/5 rounded-xl md:mx-auto md:m-6 px-8 py-4">
        <p className="text-5xl text-white font-ff text-center">
          Who is Mintplex?
        </p>
        <div className="grid grid-cols-2 gap-y-8 mx-auto p-14">
          <div className="flex flex-col space-y-3 w-full justify-center items-center">
            <img
              src="https://mintplex.xyz/static/media/timfp.7af2d242.webp"
              alt="Team member tcarambat.eth"
              className="w-60 h-60 rounded-lg shadow-md cursor-pointer"
            />
            <p className="font-ff text-white font-bold text-3xl">
              tcarambat.eth
            </p>
            ...
            <div className="flex space-x-3 justify-start w-full md:w-2/3">
              ...
              >
                <img
                  src="https://mintplex.xyz/static/media/os.1f5996d8.svg"
                  className="h-6 w-6"
                  alt="Opensea.io"
                />
              </a>
          ...
          <div className="flex flex-col space-y-3 w-full justify-center items-center">
            <img
              src="https://mintplex.xyz/static/media/jorrelfp.d7a067a1.webp"
              alt="Team member jorrel.eth"
              className="w-60 h-60 rounded-lg shadow-md cursor-pointer"
            />
            <p className="font-ff text-white font-bold text-3xl">jorrel.eth</p>
            <p className="w-full md:w-2/3 text-white leading-tight">
              Music NFT &amp; DAO enthusiast, data and customer obsessed
            </p>
            <div className="flex space-x-3 justify-start w-full md:w-2/3">
              <a
                alt="Jorrel Twitter Profile"
                className="text-white"
