  ...
  return (
    <section className="py-4">
      <div className="flex-col space-y-4 pt-4 px-2">
        <h2 className="font-ff text-5xl text-center font-bold text-black">
          Why Mintplex?
        </h2>
        <p className="text-gray-500 text-base text-center">
          Mintplex is a collection of all the tools you need to launch and grow
          your NFT without compromises or code.
        </p>
      </div>
      <div className="grid grid-cols-0 md:grid-cols-3 gap-4 mx-auto p-4 md:px-14 ">
        <div className="w-full py-8 px-6 rounded-lg border-2 border-[#344887]">
          <div className="flex items-center">
            ...
            <div className="ml-4 text-3xl font-ff font-semibold font-ff">
              Tailor-made contracts
            </div>
          </div>
          <p className="leading-loose text-gray-500  text-md">
            Mintplex supports ERC-721A and ERC-1155 contract generation. Create
            a gas efficient and purpose built contracts for your project in 5
            minutes.
          </p>
        </div>
        <div className="w-full py-8 px-6 rounded-lg border-2 border-[#344887]">
          <div className="flex items-center">
            ...
            <div className="ml-4 text-3xl font-ff font-semibold ">
        ...
        <div className="w-full py-8 px-6 rounded-lg border-2 border-[#344887]">
          ...
          <p className="leading-loose text-gray-500  text-md">
            The contract is just the beginning - we help you take your community
            public with a simple embed button that works on all no-code website
            builders.
          </p>
        </div>
        <div className="w-full py-8 px-6 rounded-lg border-2 border-[#344887]">
        ...
        <div className="w-full py-8 px-6 rounded-lg border-2 border-[#344887]">
          ...
          <p className="leading-loose text-gray-500  text-md">
            Mintplex is open for all. No payment upfront. No email signup. Just
            connect your wallet and launch.
          </p>
        </div>
        <div className="w-full py-8 px-6 rounded-lg border-2 border-[#344887]">
          <div className="flex items-center">
          ...
          <p className="leading-loose text-gray-500  text-md">
            Once launched your collection is automatically listed and compatible
            with all NFT marketplaces.
          </p>
        </div>
      </div>
